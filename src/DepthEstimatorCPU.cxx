...
void DepthEstimatorCPU::init_opencl(){
    VLOG(1) << "init opencl";
...
void DepthEstimatorCPU::compile_kernels(){
...
void DepthEstimatorCPU::run_speed_test(){
...
void DepthEstimatorCPU::run_speed_test_img(Frame& frame){
...
void DepthEstimatorCPU::run_speed_test_img2(Frame& frame){
...
void DepthEstimatorCPU::create_blur_mask(std::vector<float>& mask, const int sigma){
...
void DepthEstimatorCPU::create_half_blur_mask(std::vector<float>& mask, const int sigma){
...
void DepthEstimatorCPU::optimize_blur_for_gpu_sampling(std::vector<float>&gaus_mask, std::vector<float>& gaus_offsets){
...
void DepthEstimatorCPU::run_speed_test_img_3_blur(Frame& frame){
...
void DepthEstimatorCPU::run_speed_test_img_4_sobel(Frame& frame){
...
void DepthEstimatorCPU::run_speed_test_img_4_sobel_gray(Frame& frame){
...
void DepthEstimatorCPU::run_speed_test_img_4_blur_gray(Frame& frame){
...
void DepthEstimatorCPU::run_speed_test_img_4_blur_gray_safe(Frame& frame){
...
void DepthEstimatorCPU::gaussian_blur(cl::Image2DSafe& dest_img, const cl::Image2DSafe& src_img, const int sigma){
...
void DepthEstimatorCPU::compute_depth(Frame& frame){
...
Eigen::Vector2d DepthEstimatorCPU::estimate_affine(std::vector<ImmaturePoint>& immature_points, const Frame&  cur_frame, const Eigen::Matrix3d& KRKi_cr, const Eigen::Vector3d& Kt_cr){
...
void DepthEstimatorCPU::update_immature_points(std::vector<ImmaturePoint>& immature_points, const Frame& frame, const Eigen::Affine3d& tf_cur_host, const Eigen::Matrix3d& KRKi_cr, const Eigen::Vector3d& Kt_cr, const Eigen::Vector2d& affine_cr){
...
void DepthEstimatorCPU::search_epiline_bca(ImmaturePoint& point, const Frame& frame, const Eigen::Matrix3d& KRKi_cr, const Eigen::Vector3d& Kt_cr, const Eigen::Vector2d& affine_cr){
...
void DepthEstimatorCPU::search_epiline_ncc(ImmaturePoint& point, const Frame& frame, const Eigen::Matrix3d& KRKi_cr, const Eigen::Vector3d& Kt_cr){
...
void DepthEstimatorCPU::update_idepth(ImmaturePoint& point, const Eigen::Affine3d& tf_host_cur, const float z, const double px_error_angle){
...
double DepthEstimatorCPU::compute_tau(const Eigen::Affine3d & tf_host_cur, const Eigen::Vector3d& f, const double z, const double px_error_angle){
