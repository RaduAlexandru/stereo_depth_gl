...
layout(binding=0, rgba32f) uniform readonly image2D fbo_rgba_texture; //stores val_mu_denoised mu_head amd p_vec
...
void main(void) {
    ...
    float new_mu=imageLoad(fbo_rgba_texture, pos_xy ).x;
    p[id].mu=new_mu;
